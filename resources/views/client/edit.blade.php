...
<div class="container">
    ...
    <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Client Edit Form</h4>
                    <form class="form-sample" method="post" action="{{route('update.client')}}">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              ...
                              <input type="text" name="customer_no" value="{{$client->customer_no}}" readonly="" class="form-control">
                            </div>
                          </div>
                        </div>
                        @csrf
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="company_id" value="{{$client->company}}" class="form-control">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" value="{{$client->customer_name}}" name="customer_name" maxlength="100" class="form-control">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="city" maxlength="100" value="{{$client->city}}" class="form-control">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="state" maxlength="100" value="{{$client->state}}" class="form-control">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" name="mobile_no" value="{{$client->mobile_no}}" required="" maxlength="10" class="form-control">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" name="alt_mobile_no" value="{{$client->alt_mobile_no}}" maxlength="10" class="form-control">
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Created Date</label>
                              <div class="col-sm-9">
                                <input type="date" name="created_at" value="{{date('Y-m-d',strtotime($client->created_at))}}" class="form-control">
                              </div>
                            </div>
                          </div>                          
                        </div>
